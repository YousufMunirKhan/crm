        ...
        foreach ($users as $u) {
            ...
            $report[] = [
                ...
                'tickets_resolved' => $myTicketsResolved->map(fn (Ticket $t) => [
                    ...
                    'customer_business_name' => $t->customer?->business_name,
                ...
                'leads_added_list' => $myLeadsAdded->map(fn (Lead $lead) => [
                    ...
                    'customer_business_name' => $lead->customer?->business_name,
                    'stage' => $lead->stage,
                ])->values(),
                ...
                'crm_activity_preview' => $leadActs->take(50)->map(fn (LeadActivity $la) => [
                    ...
                    'customer_business_name' => $la->lead?->customer?->business_name,
                    'lead_id' => $la->lead_id,
                ])->values(),
                'timeline' => $timeline,
            ];
