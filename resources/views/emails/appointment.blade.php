...
<body>
    <div class="email-container">
        <div class="header">
            @if($logoUrl)
                <img src="{{ url($logoUrl) }}" alt="{{ $companyName }}">
            @endif
        ...
        <div class="content">
            ...
            <p style="font-size: 16px; color: #334155; margin-bottom: 16px;">
                Thank you for giving us your time. We are pleased to confirm your appointment with {{ $companyName }}.
            </p>
            <p style="font-size: 16px; color: #334155; margin-bottom: 8px;">
                <strong>Our team member will visit you at the following date and time:</strong>
            </p>
            @else
            <p>
            ...
            <p style="margin-top: 25px;">
                If you need to reschedule or cancel this appointment, please contact us at your earliest convenience.
            </p>
            @endif
        </div>
        ...
        <div class="footer">
            ...
            <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #e2e8f0;">
                @if(isset($companyRegistrationNo) && $companyRegistrationNo)
                    <p style="font-size: 12px; color: #64748b; margin: 3px 0;">
                        Company No: {{ $companyRegistrationNo }}
                    </p>
                @endif
                @if(isset($companyVat) && $companyVat)
                    <p style="font-size: 12px; color: #64748b; margin: 3px 0;">
